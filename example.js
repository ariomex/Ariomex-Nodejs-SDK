const Ariomex = require('./ariomex');  // Assuming the Ariomex SDK is in the same directory
...
// const irtWithdrawalResponse = await ariomex.wallet.withdrawIrt('100', 'iban_uuid_here');
// // Example usage of the withdrawCrypto method
// const cryyptoWithdrawalResponse = await ariomex.wallet.withdrawCrypto('btc', 'btc', '1', 'address_uuid_here', 'optional_memo');
